...
var nodes_pl = {
	types_pl.BASIC : preload("res://scenes/Platform_standart.tscn"),
	types_pl.BROKEN : preload("res://scenes/Platform_broken.tscn"),
	types_pl.CHIPPED : preload("res://scenes/Platform_chipped.tscn"),
	types_pl.CHIPPED_UP : preload("res://scenes/Platform_chipped_up.tscn"),
	types_pl.CHIPPED_DOWN : preload("res://scenes/Platform_chipped_down.tscn"),
	types_pl.CRAB : preload("res://scenes/Platform_crab.tscn"),
	types_pl.JUMP : preload("res://scenes/Platform_jump.tscn")
}
